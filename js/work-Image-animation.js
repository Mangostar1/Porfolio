...
window.addEventListener('mouseover', (e) => {
    if (e.target === overlayWork[0] || e.target === tecUsed[0] || e.target === descriptWork[0]) {
            imgWorks[0].style.cssText = `transition: all ${timeTrans}s ease; transform: scale(${scale})`;
    } 
    else if (e.target === overlayWork[1] || e.target === tecUsed[1] || e.target === descriptWork[1]) {
        imgWorks[1].style.cssText = `transition: all ${timeTrans}s ease; transform: scale(${scale})`;
    } 
    else if (e.target === overlayWork[2] || e.target === tecUsed[2] || e.target === descriptWork[2]) {
        imgWorks[2].style.cssText = `transition: all ${timeTrans}s ease; transform: scale(${scale})`;
    } 
    else if (e.target === overlayWork[3] || e.target === tecUsed[3] || e.target === descriptWork[3]) {
        imgWorks[3].style.cssText = `transition: all ${timeTrans}s ease; transform: scale(${scale})`;
    } 
    else if (e.target === overlayWork[4] || e.target === tecUsed[4] || e.target === descriptWork[4]) {
        imgWorks[4].style.cssText = `transition: all ${timeTrans}s ease; transform: scale(${scale})`;
    } 
    else if (e.target === overlayWork[5] || e.target === tecUsed[5] || e.target === descriptWork[5]) {
        imgWorks[5].style.cssText = `transition: all ${timeTrans}s ease; transform: scale(${scale}`;
    } 
    else if (e.target === overlayWork[6] || e.target === tecUsed[6] || e.target === descriptWork[6]) {
